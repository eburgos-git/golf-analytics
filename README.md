...
- **Corto (juego corto y putt)**: registro manual de tus tres ejercicios de la cancha de práctica — vuelta al putting green (fecha, score vs par contando 2 putts/hoyo, green: Valle 1 / Valle 10 / Driving, hoyos opcionales) y tandas de aproximación desde 10 y 20 pasos (fecha, palo, bolas que quedan en green de N tiros). Analiza progresión por green y por distancia, ranking de palos, regularidad entre tandas, tendencias por regresión y compara tus putts por hoyo del putting green con los de tus rondas reales.
